...
// SEO Schema
const flexibleTarrifSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Flexible Parking Tariffs",
  description: "Customizable parking tariff management system for efficient pricing control",
...
const FlexibleTarrif: React.FC = () => {
  ...
  const setupAnimation = useCallback(() => {
    ...
    const flexibleTarrifTimeline = gsap.timeline({
      scrollTrigger: {
    ...
    >
      <div className="mx-auto xl:px-20 md:px-10 px-6 w-full">
        <div className="flex justify-center items-center gap-10 lg:flex-row flex-col tariff-section">
          <div
            ref={refs.image} 
            className="lg:w-1/2 w-full tariff-image"
            role="img"
            aria-label="Flexible tariff system illustration"
          >
            <StaticImage
              src="../../assets/images/tarriff.svg"
...
export default FlexibleTarrif;

export const Head: HeadFC = () => (
  <>
    <title>Flexible Parking Tariffs | Parkolay</title>
    <meta name="description" content="Customizable parking tariff management system for efficient pricing control" />
    <meta name="keywords" content="flexible parking tariffs, parking rates, tariff management, parking solutions, Parkolay" />
    <meta property="og:title" content="Flexible Parking Tariffs | Parkolay" />
    <meta property="og:description" content="Customizable parking tariff management system for efficient pricing control" />
    <meta property="og:type" content="product" />
    <link rel="canonical" href="https://parkolay.com/products/flexible-tariffs" />
    <meta name="robots" content="index, follow" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="" />
    <script type="application/ld+json">
      {JSON.stringify(flexibleTarrifSchema)}
    </script>
  </>
);